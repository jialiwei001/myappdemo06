...
public class AnimalResource {
    ...
    public AnimalResource(AnimalRepository animalRepository, AnimalSearchRepository animalSearchRepository) {
    ...
    @Timed
    public List<Animal> searchAnimals(@RequestParam String query) {
